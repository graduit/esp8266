...
$setupArray = array(
	...
	'applicationId' => 'amzn1.ask.skill.db0f5a1e-1f3a-49d6-b81b-25c77a9843dd', // From your Alexa developer console
	...
	'awsAccount' => 'amzn1.ask.account.AGUOLHXHMGI5RLECHSNI3N5X4MIWVKLKFHDPSLHBRCBY2I7DJNH6CF4CMDHW42GFF5SPSM4OY2NXALCQMZAYIRCZXY6NICICJHQVIQDTSF7FZPX3VDYNELUGU6KNVCP7VJN7ZVIBH25P3IGPGYMQ36JXNJPBNXS5TUBU2J3UW2RFCMEB3OARPCXTZNIIOK74FOYMWCZUYDBQ67I', // If this is != empty the specified session->user->userId is required. This is useful for account bound private only skills
	'validIp' => false,
	// 'validIp' => array(
...
function getRequestPayload($payload) {
	...
	$host = "http://101.98.202.3"; // Enter your domain name, or IP Address here
